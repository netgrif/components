...
export interface Services {
    ...
    auth?: {
        /**
         * @deprecated in 6.1.0C use [onLogoutRedirect]{@link Services#auth.onLogoutRedirect} instead
         *
        ...
        /**
         * @deprecated in 6.1.0C use [toLoginRedirect]{@link Services#auth.toLoginRedirect} instead
         *
