...
describe('FieldConvertorService', () => {
    ...
    it('should test format value', () => {
        ...
        const date = moment();
        dataField.type = DataFieldType.DATE;
