...
export class FilesUploadItemComponent implements OnInit {
    /**
     * Binding property [FileFieldService]{@link FileFieldService} from parent [FilesUploadListComponent]{@link FilesUploadListComponent}.
     */
    @Input() public fileFieldService: FileFieldService;
    /**
     * Binding property file from parent [FilesUploadListComponent]{@link FilesUploadListComponent}.
     */
