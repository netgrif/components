...
export abstract class Category {
     ...
     */
    public generateQuery(userInput: Array<string>): Query {
        if (!this._selectedOperator) {
            throw new Error('Category cannot generate a Query if no Operator is selected');
        }
        return this._selectedOperator.createQuery(this._elasticKeywords, userInput);
    }
     ...
     */
    public generatePredicate(userInput: Array<string>): ElementaryPredicate {
