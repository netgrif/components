 ...
 */
export type GeneratorMetadata = FilterMetadata | Array<CategoryGeneratorMetadata> | CategoryGeneratorMetadata;
 ...
 */
export type FilterMetadata = Array<Array<CategoryGeneratorMetadata>>;
