...
@Component({
    ...
    templateUrl: './group-view-group-view.component.html',
    styleUrls: ['./group-view-group-view.component.scss'],
    providers: [
...
export class GroupViewGroupViewComponent extends AbstractTaskView implements AfterViewInit {
