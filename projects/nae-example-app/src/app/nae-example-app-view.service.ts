...
export class NaeExampleAppViewService extends ViewService {
    constructor() {
        ...
        super([ButtonsNavComponent, NavigationExampleComponent, ProfileComponent, FilterRepositoryExampleComponent, DashboardExampleComponent, WorkflowViewExampleComponent, TabbedViewsExampleComponent, CaseViewComponent, TaskViewComponent, PanelsComponent, ToolbarExampleComponent, ReactiveTextFieldComponent, TabViewExampleComponent, DialogExampleComponent, SnackBarExampleComponent, SidemenuExampleComponent, HeadersComponent, RailExampleComponent, DrawerExampleComponent, RegisterFormComponent, PasswordFormComponent, LoginFormComponent, AuthenticationComponent]);
    }
}
