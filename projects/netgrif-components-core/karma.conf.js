...
module.exports = function(config) {
    config.set({
        ...
        coverageIstanbulReporter: {
            dir: require("path").join(__dirname, "../../coverage/netgrif-components-core"),
        ...
        junitReporter: {
            outputDir: "../../coverage/netgrif-components-core/", // results will be saved as $outputDir/$browserName.xml
