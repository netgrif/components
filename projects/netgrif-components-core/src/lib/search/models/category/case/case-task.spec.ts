...
describe('CaseTask', () => {
    ...
    beforeEach(waitForAsync(async () => {
        ...
        category = await new CaseTask(operatorService, null, createMockDependencies(allowedNets$, operatorService));
    }));
    ...
    it('should serialize complete instance', () => {
        ...
        expect(metadata.category).toBe(Categories.CASE_TASK);
    ...
    it('should deserialize stored instance', (done) => {
        ...
        const metadata = category.createMetadata();
        expect(metadata).toBeTruthy();
        const deserialized = new CaseTask(operatorService, null, createMockDependencies(allowedNets$, operatorService));
