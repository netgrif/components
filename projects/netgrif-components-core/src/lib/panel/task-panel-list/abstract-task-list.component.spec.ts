...
describe('AbstractTaskListComponent', () => {
    ...
    it('should import transitionId', () => {
        component.resolveTaskArray(component.tasks$)
        expect(component.transitionId$).toEqual('string2');
    });
