...
export class DateField extends AbstractTimeInstanceField {
    ...
    constructor(stringId: string, title: string, value: Moment, behavior: Behavior, placeholder?: string,
                ...
                _validationRegistry?: ValidationRegistryService, _injector?: Injector) {
        super(stringId, title, value, behavior, placeholder, description, layout, validations, component, parentTaskId, _validationRegistry, _injector);
    }
