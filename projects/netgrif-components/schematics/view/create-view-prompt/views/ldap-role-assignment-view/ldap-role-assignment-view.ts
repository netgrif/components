...
export function createLdapRoleAssignmentView(tree: Tree, args: CreateViewArguments, addViewToService: boolean): Rule {
    ...
    rules.push(createFilesFromTemplates('./views/ldap-role-assignment-view/files', destinationPath, templateParams));
