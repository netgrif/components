...
const projectName = 'NETGRIF Components - Frontend';
const projectKey = 'Engine-components';
const lcovPath = 'coverage/netgrif-components/lcov.info';
const sources = 'projects/netgrif-components';
const exclusions = 'projects/netgrif-components/**/*.spec.ts,./projects/netgrif-components/src/scripts';
