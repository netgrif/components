// TODO: if ngAfterInit will be changed to OnInit, this test can be used
//  (Angular 13: ExpressionChangedAfterItHasBeenCheckedError error should only appear in developer console)
