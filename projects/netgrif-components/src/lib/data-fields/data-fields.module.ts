...
export class DataFieldsComponentModule {
    ...
    constructor(componentRegistry: ComponentRegistryService) {
        componentRegistry.register('boolean-default', (injector: Injector) => new ComponentPortal<any>(BooleanDefaultFieldComponent, null, injector));
        componentRegistry.register('button-default', (injector: Injector) => new ComponentPortal<any>(ButtonDefaultFieldComponent, null, injector));
        componentRegistry.register('date-default', (injector: Injector) => new ComponentPortal<any>(DateDefaultFieldComponent, null, injector));
        componentRegistry.register('date-time-default', (injector: Injector) => new ComponentPortal<any>(DateTimeDefaultFieldComponent, null, injector));
        componentRegistry.register('enumeration-default', (injector: Injector) => new ComponentPortal<any>(EnumerationSelectFieldComponent, null, injector));
        componentRegistry.register('enumeration-autocomplete_dynamic', (injector: Injector) => new ComponentPortal<any>(EnumerationAutocompleteDynamicFieldComponent, null, injector));
        componentRegistry.register('enumeration-autocomplete', (injector: Injector) => new ComponentPortal<any>(EnumerationAutocompleteSelectFieldComponent, null, injector));
