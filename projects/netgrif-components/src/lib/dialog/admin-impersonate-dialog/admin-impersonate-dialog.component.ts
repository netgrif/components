...
@Component({
    selector: 'nc-admin-impersonate-dialog',
    templateUrl: './admin-impersonate-dialog.component.html',
...
export class AdminImpersonateDialogComponent {
     ...
     */
    constructor(protected _dialogRef: MatDialogRef<AdminImpersonateDialogComponent>,
