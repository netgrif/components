define(['angular', '../modules/Tasks', '../modules/Main'],
    function (angular) {
        angular.module('ngTasks').controller('TasksController',
            ['$log', '$scope', '$http', '$user', '$snackbar', '$dialog', '$bottomSheet', '$fileUpload','$mdExpansionPanelGroup','$mdExpansionPanel','$timeout',
                function ($log, $scope, $http, $user, $snackbar, $dialog, $bottomSheet, $fileUpload, $mdExpansionPanelGroup, $mdExpansionPanel, $timeout) {
                    var self = this;
                    var statusOrder = {
                        New: 1,
                        Assigned: 2,
